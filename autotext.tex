...
%		k=\the\value{k}, l=\the\value{l}, m=\the\value{m}
		...
		\ifthenelse{\value{l} = 1}{\Chapter{Level \the\value{l} Auto Text \the\value{m}} Chapter text.  This is a citation Ref.~\cite{Lighthall_2010}.}{}%
...
\footnotesize{The Auto Text command takes three arguments, which have been entered as \texttt{\{#1\}\{#2\}\{#3\}}.
